...
if __name__ == '__main__':
    ...
    if args.per_bir_comp:
        ...
        print("--->  dg_prop = {}     --    {}".format(dg_prop_list_onlybir[np.argmax(ave_prec_bir_no_rtf)],
                                                       np.max(ave_prec_bir_no_rtf)))
        print("\n\nBI-R minus CONDITIONAL REPLAY")
        print(" param-list (dg_prop): {}".format(dg_prop_list_onlybir))
        print("  {}".format(ave_prec_bir_no_con))
        print("--->  dg_prop = {}     --    {}".format(dg_prop_list_onlybir[np.argmax(ave_prec_bir_no_con)],
                                                       np.max(ave_prec_bir_no_con)))
        print("\n\nBI-R minus INTERNAL REPLAY")
        print(" param-list (dg_prop): {}".format(dg_prop_list_onlybir))
        print("  {}".format(ave_prec_bir_no_int))
        print("--->  dg_prop = {}     --    {}".format(dg_prop_list_onlybir[np.argmax(ave_prec_bir_no_int)],
                                                       np.max(ave_prec_bir_no_int)))
        print("\n\nBI-R minus DISTILLATION")
        print(" param-list (dg_prop): {}".format(dg_prop_list_onlybir))
        print("  {}".format(ave_prec_bir_no_dis))
        print("--->  dg_prop = {}     --    {}".format(dg_prop_list_onlybir[np.argmax(ave_prec_bir_no_dis)],
                                                       np.max(ave_prec_bir_no_dis)))
        print("\n\nGR plus GATING BASED ON INTERNAL CONTEXT")
        print(" param-list (dg_prop): {}".format(dg_prop_list_onlybir))
        print("  {}".format(ave_prec_gr_plus_gat))
        print("--->  dg_prop = {}     --    {}".format(dg_prop_list_onlybir[np.argmax(ave_prec_gr_plus_gat)],
                                                       np.max(ave_prec_gr_plus_gat)))
    print('\n')
    ...
    if args.per_bir_comp:
        full_list += (ave_prec_bir_no_rtf + ave_prec_bir_no_con + ave_prec_bir_no_dis + ave_prec_bir_no_int
                      + ave_prec_gr_plus_gat)
    ...
    ###---Brain-Inspired Replay---###
    figure = my_plt.plot_lines([ave_prec_bir], x_axes=dg_prop_list_onlybir, ylabel=ylabel,
    ...
    ###---BI-R per component---###
    if args.per_bir_comp:
        figure = my_plt.plot_lines([ave_prec_bir_no_rtf, ave_prec_bir_no_con, ave_prec_bir_no_int, ave_prec_bir_no_dis,
                                    ave_prec_gr_plus_gat],
